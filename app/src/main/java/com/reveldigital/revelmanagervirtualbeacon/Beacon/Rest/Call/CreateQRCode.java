...
public class CreateQRCode extends AsyncTask<String, String, String> {
    OkHttpClient client = new OkHttpClient();
    Context appContext;
    IResponder responder;
    String regKey, apiKey, playlist_ID;

    public CreateQRCode(IResponder r, Context e, String regKey, String apiKey, String playlist_ID) {
        responder = r;
        appContext=e;
        this.regKey = regKey;
        this.apiKey = apiKey;
